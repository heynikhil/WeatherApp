...
public class levelActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        seaView = (TextView) findViewById(R.id.speedView);
        grndView = (TextView) findViewById(R.id.degView);
                ...
                (Request.Method.GET, url, null, new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject responseObject) {
                        ...
                        try {
                            ...
                            String sea_level = Integer.toString((int) Math.round(mainJSONObject.getDouble("sea_level")));
                            String grnd_level = Integer.toString((int) Math.round(mainJSONObject.getDouble("grnd_level")));

                            seaView.setText(sea_level);
                            grndView.setText(grnd_level);
